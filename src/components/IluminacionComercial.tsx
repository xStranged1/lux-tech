  ...
  return (
    <section 
      className={`min-h-screen py-20 transition-colors duration-500 ${
        darkMode ? 'bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950' : 'bg-gradient-to-br from-gray-50 via-white to-gray-50'
      }`}
    >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className={`rounded-2xl p-6 border-2 ${
              ...
              <div className={`text-xs mt-3 pt-3 border-t ${
                darkMode ? 'border-amber-500/20 text-amber-200' : 'border-amber-300 text-amber-800'
              }`}>
            ...
            <div className={`rounded-2xl p-6 border-2 ${
              ...
              <p className={`text-sm mb-2 ${
                ...
                LuminaTech alinea la luz con el reloj biológico.
              </p>
              <div className={`text-xs mt-3 pt-3 border-t ${
                darkMode ? 'border-amber-500/20 text-amber-200' : 'border-amber-300 text-amber-800'
              }`}>
